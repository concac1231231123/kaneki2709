...
// Function to apply the chosen theme background image
function applyTheme(themeImage) {
    // Get the container element with the class 'library'
    const container = document.querySelector('.container.library');
    
    // Check if the container exists
    if (container) {
        // Set the background image for the container
        container.style.backgroundImage = `url("${themeImage}")`;
        // Set other background properties for the container
        container.style.backgroundRepeat = 'no-repeat';
        container.style.backgroundSize = 'cover';
        container.style.backgroundAttachment = 'fixed';
    }

    // Get the element with the class 'stickyScrollHeader'
    const stickyScrollHeader = document.querySelector('.stickyScrollHeader');
    
    // Check if the stickyScrollHeader element exists
    if (stickyScrollHeader) {
        // Set the background image for the stickyScrollHeader
        stickyScrollHeader.style.backgroundImage = `url("${themeImage}")`;
        // Set other background properties for the stickyScrollHeader
        stickyScrollHeader.style.backgroundRepeat = 'no-repeat';
        stickyScrollHeader.style.backgroundSize = 'cover';
        stickyScrollHeader.style.backgroundAttachment = 'fixed';
    }
}
